      ...
      <div className="flex flex-col gap-16">
        ...
        <FadeUp delay={0.1}>
          <div className="flex flex-col md:flex-row w-full gap-8 md:gap-0 items-center">
            <Link href="/journal/color-theory" className="w-full md:w-[42%] block group overflow-hidden rounded-[4px]">
              <img
                src="https://picsum.photos/seed/journal1/800/500"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <FadeUp delay={0.2}>
            <Link href="/journal/natural-dyes" className="block group">
              <div className="overflow-hidden rounded-[4px] mb-6">
                <img
                  src="https://picsum.photos/seed/journal2/600/337"
                  alt="Journal 2"
          ...
          <FadeUp delay={0.3}>
            <Link href="/journal/studio-visit" className="block group">
              <div className="overflow-hidden rounded-[4px] mb-6">
                <img
                  src="https://picsum.photos/seed/journal3/600/337"
                  alt="Journal 3"
                  className="w-full aspect-video object-cover transition-transform duration-500 group-hover:scale-105"
                />
              </div>
